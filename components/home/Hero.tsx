            ...
            <div className="grid grid-cols-1 gap-y-12 lg:grid-cols-2 lg:gap-x-12 items-center">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <div className="mt-10 flex gap-6">
                        <Link href="/resume" className="px-10 py-4 rounded-none bg-cobalt text-white font-bold uppercase tracking-wider hover:bg-night transition-all hover:scale-105 inline-block text-center">
                            See My Work
                        </Link>
                    </div>
                </div>
