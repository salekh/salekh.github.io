        ...
        <header className="sticky top-0 z-50 py-6 backdrop-blur-md bg-white/70 dark:bg-zinc-900/70 border-b border-zinc-100 dark:border-white/5">
            <Container>
                <nav className="flex items-center justify-between">
                    <Link href="/" className="relative h-12 w-12 hover:opacity-80 transition-opacity">
                        <img
                    ...
                    <div className="flex gap-8 text-base font-bold uppercase tracking-wider text-zinc-900 dark:text-zinc-100">
